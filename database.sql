-- Script de création de la base de données rifline
-- À exécuter dans phpMyAdmin (MAMP) ou via mysql CLI

CREATE DATABASE IF NOT EXISTS rifline CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE rifline;
